...
class_name JSONTestObject_4_4 extends RefCounted
...
var type_empty_typed_dictionary: Dictionary[String, Node] = {}
var type_empty_key_typed_dictionary: Dictionary[Node, Variant] = {}
var type_empty_value_typed_dictionary: Dictionary[Variant, Node] = {}
