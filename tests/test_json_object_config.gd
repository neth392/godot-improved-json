...
func test_extended_config_returns_all_properties() -> void:
	...
	var parent_config: SerializationObjectConfig = SerializationObjectConfig.new()
	var parent_property: SerializableProperty = SerializableProperty.new()
	parent_property.key = "parent_config"
	parent_property.property_name = "parent_property"
	parent_config.properties.append(parent_property)
	
	# Set up extended config
	var child_config: SerializationObjectConfig = SerializationObjectConfig.new()
	var child_property: SerializableProperty = SerializableProperty.new()
	child_property.key = "child_config"
	...
	var properties: Array[SerializableProperty] = child_config.get_properties_extended()
